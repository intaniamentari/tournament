          ...
          <div class="service-item rounded h-100 p-5">
            <div class="d-flex align-items-center ms-n5 mb-4">
              ...
              >
                <img
                  class="img-fluid"
                  src="{{ asset('landing_page/img/icon/icon-10-light.png') }}"
                  alt=""
                />
              </div>
          ...
          <div class="service-item rounded h-100 p-5">
            <div class="d-flex align-items-center ms-n5 mb-4">
              ...
              >
                <img
                  class="img-fluid"
                  src="{{ asset('landing_page/img/icon/icon-01-light.png') }}"
                  alt=""
                />
              </div>
          ...
          <div class="service-item rounded h-100 p-5">
            <div class="d-flex align-items-center ms-n5 mb-4">
              ...
              >
                <img
                  class="img-fluid"
                  src="{{ asset('landing_page/img/icon/icon-05-light.png') }}"
                  alt=""
                />
              </div>
          ...
          <div class="service-item rounded h-100 p-5">
            <div class="d-flex align-items-center ms-n5 mb-4">
              ...
              >
                <img
                  class="img-fluid"
                  src="{{ asset('landing_page/img/icon/icon-08-light.png') }}"
                  alt=""
                />
              </div>
          ...
          <div class="service-item rounded h-100 p-5">
            <div class="d-flex align-items-center ms-n5 mb-4">
              ...
              >
                <img
                  class="img-fluid"
                  src="{{ asset('landing_page/img/icon/icon-07-light.png') }}"
                  alt=""
                />
              </div>
          ...
          <div class="service-item rounded h-100 p-5">
            <div class="d-flex align-items-center ms-n5 mb-4">
              ...
              >
                <img
                  class="img-fluid"
                  src="{{ asset('landing_page/img/icon/icon-06-light.png') }}"
                  alt=""
                />
              </div>
